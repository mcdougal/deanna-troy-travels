...
const EmbeddedInstagramPost = ({
  ...
  // Re-process embeds whenever this component mounts/updates.
  useEffect(() => {
  ...
  return (
    <>
      {/* Load once per page; Next dedupes by src */}
      <Script
        onLoad={() => {
          window.instgrm?.Embeds?.process();
        }}
